...
namespace ppanam
{
    public partial class Form4 : Form
    {
        ...
        private void Delivery_form_Load(object sender, EventArgs e)
        {
            ...
            conn.Open();
            sql_ = "SELECT * FROM project_tbl WHERE Tester = 1 and progress >= 70";
            cmd.CommandText = sql_;
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            cmd.Connection = conn;
            string sql_ = "UPDATE menual_tbl SET explane = '" + richTextBox1.Text + "' WHERE pid = 3";
            cmd.CommandText = sql_;
            cmd.ExecuteNonQuery();
            conn.Close();
            conn.Open();
        ...
        private void Button8_Click(object sender, EventArgs e)
        {
            ...
            if (pg == 70)
            {
                sql_ = "UPDATE project_tbl SET progress = 80 WHERE pid =" + pid;
                cmd.CommandText = sql_;
                result = cmd.ExecuteNonQuery();
            }
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            cmd.Connection = conn;
            string sql_ = "UPDATE menual_tbl SET explane = '" + richTextBox2.Text + "' WHERE pid = 5";
            cmd.CommandText = sql_;
            cmd.ExecuteNonQuery();
            conn.Close();
            conn.Open();
